...
from tfscreen.growth_model.populate_dataclass import populate_dataclass

from tfscreen.growth_model.model import jax_model
from tfscreen.growth_model.registry import model_registry
from tfscreen.growth_model.batch import get_batch

from tfscreen.growth_model.data_class import (
    DataClass,
    BindingData,
    GrowthData,
    PriorsClass,
...
def _build_growth_tm(growth_df, growth_shares_replicates=False):
    ...
    Returns
    -------
    tfscreen.growth_model.TensorManager
...
class ModelClass:
    ...
    def _initialize_data(self):
        ...
        if _needs_struct:
            ...
            from tfscreen.growth_model.components.theta.struct.io import (
