...
from tfscreen.tfmodel.generative.components.growth_transition._baranyi import compute_growth
...
def get_extract_specs(ctx):
    ...
    return [dict(
        ...
        params_to_get=["growth_transition_tau",
                       "growth_transition_ln_k0",
                       "growth_transition_ln_gamma"],
