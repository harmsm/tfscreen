...
def sample_posterior(config_file,
    ...
    out_prefix : str, optional
        Prefix for posterior output files (default 'tfs'). The posterior is
        written to {out_prefix}_posterior.h5.
    seed : int, optional
    ...
    _run_svi(ri,
             ...
             # Convergence / optimizer kwargs are unused at 0 epochs but required
             # by _run_svi's signature; use neutral defaults.
             adam_step_size=1e-3,
