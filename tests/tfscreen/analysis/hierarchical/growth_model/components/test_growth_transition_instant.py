...
from tfscreen.analysis.hierarchical.growth_model.components.growth_transition_instant import (
...
def test_define_model():
    ...
    total_growth = define_model("test", data, priors, g_pre, g_sel, t_pre, t_sel)
