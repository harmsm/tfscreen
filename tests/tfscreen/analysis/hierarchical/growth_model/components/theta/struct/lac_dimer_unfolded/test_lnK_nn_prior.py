...
from tfscreen.analysis.hierarchical.growth_model.components.theta.struct.lac_dimer_unfolded.lnK_nn_prior import (
    STRUCTURE_NAMES,
    ModelPriors,
    _check_struct_names,
    _project_ddG,
...
def test_registry_entry():
    ...
    import tfscreen.analysis.hierarchical.growth_model.components.theta.struct.lac_dimer_unfolded.lnK_nn_prior as mod
