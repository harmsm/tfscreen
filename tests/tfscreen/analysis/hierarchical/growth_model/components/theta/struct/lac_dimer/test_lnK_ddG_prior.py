...
from tfscreen.analysis.hierarchical.growth_model.components.theta.struct.lac_dimer.lnK_ddG_prior import (
    STRUCTURE_NAMES,
    ModelPriors,
    _get_struct_perm,
    _project_ddG,
...
def test_registry_entry():
    ...
    import tfscreen.analysis.hierarchical.growth_model.components.theta.struct.lac_dimer.lnK_ddG_prior as mod
...
class TestGetExtractSpecs:
    ...
    def test_three_specs_even_with_pair_labels(self):
        # lnK_ddG_prior has no epistasis; pair_labels are irrelevant
