...
class TestConfig:
    ...
    def test_model_priors_has_no_nn_or_epi_fields(self):
        ...
        assert not hasattr(p, "theta_epi_tau_scale")
...
def test_registry_entry():
    ...
    import tfscreen.analysis.hierarchical.growth_model.components.theta.struct.mwc_dimer_unfolded.lnK_ddG_prior as mod
...
class TestGetExtractSpecs:
    ...
    def test_no_fourth_spec_even_with_pair_labels(self):
        """lnK_ddG_prior has no epistasis; always exactly 3 specs."""
