...
def test_get_posteriors(tmpdir, mocker):
    ...
    # Mock Predictive
    mock_predictive = mocker.patch("tfscreen.growth_model.run_inference.Predictive")
...
def test_get_site_names(mocker):
    ...
    # Mock trace and seed
    mock_trace = mocker.patch("tfscreen.growth_model.run_inference.trace")
    mock_seed = mocker.patch("tfscreen.growth_model.run_inference.seed")
