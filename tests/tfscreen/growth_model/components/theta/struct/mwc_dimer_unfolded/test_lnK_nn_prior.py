...
from tfscreen.growth_model.components.theta.struct.mwc_dimer_unfolded.lnK_nn_prior import (
    STRUCTURE_NAMES,
    ModelPriors,
    _get_struct_perm,
    _project_ddG,
...
def test_registry_entry():
    ...
    import tfscreen.growth_model.components.theta.struct.mwc_dimer_unfolded.lnK_nn_prior as mod
