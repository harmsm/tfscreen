...
from tfscreen.tfmodel.generative.components.theta.thermo.O2_C4_K3_U1_a.PnnC import (
    STRUCTURE_NAMES,
    ModelPriors,
    _check_struct_names,
    _project_ddG,
...
def test_registry_entry():
    ...
    assert "thermo.O2_C4_K3_U1_a.PnnC" in model_registry["theta"]
    import tfscreen.tfmodel.generative.components.theta.thermo.O2_C4_K3_U1_a.PnnC as mod
    assert model_registry["theta"]["thermo.O2_C4_K3_U1_a.PnnC"] is mod
