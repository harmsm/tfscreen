...
from tfscreen.tfmodel.generative.components.dk_geno.hierarchical_geno import (
    ModelPriors,
    define_model,
    guide,
    get_hyperparameters,
...
def test_define_model_unpinned_uses_sample_sites(mock_data):
    """Without any pinning, every pinnable suffix is a sample site (not deterministic)."""
    name = "dk"
