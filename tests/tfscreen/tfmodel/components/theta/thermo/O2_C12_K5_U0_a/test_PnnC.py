...
def test_registry_entry():
    ...
    assert "thermo.O2_C12_K5_U0_a.PnnC" in model_registry["theta"]
    import tfscreen.tfmodel.generative.components.theta.thermo.O2_C12_K5_U0_a.PnnC as mod
    assert model_registry["theta"]["thermo.O2_C12_K5_U0_a.PnnC"] is mod
