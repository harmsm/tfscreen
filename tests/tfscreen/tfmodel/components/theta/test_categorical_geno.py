...
from tfscreen.tfmodel.generative.components.theta.categorical_geno import (
    ModelPriors,
    ThetaParam,
    define_model,
    guide,
...
def test_population_moments_logic(mock_data):
    ...
    from tfscreen.tfmodel.generative.components.theta.categorical_geno import get_population_moments
