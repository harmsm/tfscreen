...
from tfscreen.tfmodel.generative.components.theta.struct.lac_dimer.lnK_nn_prior import (
    STRUCTURE_NAMES,
    ModelPriors,
    _check_struct_names,
    _project_ddG,
...
def test_registry_entry():
    ...
    import tfscreen.tfmodel.generative.components.theta.struct.lac_dimer.lnK_nn_prior as mod
