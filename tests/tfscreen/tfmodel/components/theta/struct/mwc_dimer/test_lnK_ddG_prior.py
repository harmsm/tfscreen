...
from tfscreen.tfmodel.components.theta.struct.mwc_dimer.lnK_ddG_prior import (
    STRUCTURE_NAMES,
    ModelPriors,
    _get_struct_perm,
    _project_ddG,
...
def test_registry_entry():
    ...
    import tfscreen.tfmodel.components.theta.struct.mwc_dimer.lnK_ddG_prior as mod
