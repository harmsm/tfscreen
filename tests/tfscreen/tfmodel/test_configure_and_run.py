...
def test_mains(mocker):
    ...
    mock_run_analysis = mocker.patch("tfscreen.tfmodel.scripts.fit_model_cli.fit_model", autospec=True)
    from tfscreen.tfmodel.scripts.fit_model_cli import main as main_run
    main_run()
...
def test_fit_model_svi_full(tmpdir, mocker):
    with patch("os.path.exists", return_value=False):
        ...
        mock_svi = mocker.patch("tfscreen.tfmodel.scripts.fit_model_cli._run_svi")
        mock_map = mocker.patch("tfscreen.tfmodel.scripts.fit_model_cli._run_map")
